...
// Cheak if user is logged in with a token which will come in header as jwtToken

app.get('/auth', async (req, res) => {
    // Decode jwt token and cheak if user exist or not
